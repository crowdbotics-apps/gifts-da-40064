"""
Django settings for gifts_da_40064 project.
...
ROOT_URLCONF = 'gifts_da_40064.urls'
...
WSGI_APPLICATION = 'gifts_da_40064.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gifts_da_40064 API",
    "DESCRIPTION": "API documentation for gifts_da_40064 App",
    "VERSION": "v1",
}
